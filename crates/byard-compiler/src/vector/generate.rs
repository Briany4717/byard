...
/// Generation grid: 32×32; high-PPI targets may opt into 64×64.
pub const GRID_SIZE: u32 = 32;
/// Baked distance range in atlas texels (RFC-0009 §1, §5, §2-E).
pub const PX_RANGE: f32 = 4.0;
/// Edge-coloring angular threshold in degrees (RFC-0009 §5).
pub const EDGE_ANGLE_DEGREES: f64 = 48.0;
/// Generator algorithm version (RFC-0009 §5). Folded into the persistent
...
/// A generated MSDF field, owned and `Send + 'static` so it can cross
