...
- **Status:** Active, implemented (events, write-back, keyboard and focus, the full event catalog, and extended exposure). All design decisions (E1 to E8) resolved 2026-06-20; code landed and verified green.
- **Author(s):** Briany4717
- **Created:** 2026-06-20
